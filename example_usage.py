...
def main():
    ...
    print("="*50)
    print("For interactive testing, open Swagger UI in your browser:")
    print(f"  📖 Swagger UI: {BASE_URL}/docs")
    print(f"  📚 ReDoc: {BASE_URL}/redoc")
    print("\nTo use the interactive Swagger UI helper:")
    print("  python3 swagger_tester.py")
    print("\nSwagger UI allows you to:")
    print("  • Test all endpoints interactively")
    print("  • See request/response schemas")
    print("  • Generate and download images")
    print("  • View real-time API responses")
    print("  • Copy curl commands for your own use")
